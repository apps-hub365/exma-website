  ...
  return (
    <div className="exma-page-wrapper exma-dir-page">
      ...
      <div ref={headRef} className="exma-dir-header">
        ...
        <h1 className="exma-dir-title exma-headline">Speekers.</h1>
        ...
        <p className="exma-dir-count">
          {filtered.length} speeker{filtered.length !== 1 ? 's' : ''} encontrados
        </p>
      </div>
      ...
      <footer className="exma-footer">
        © 2026 EXMA Speekers — Powered by Hub365.AI
      </footer>
    </div>
  );
}
