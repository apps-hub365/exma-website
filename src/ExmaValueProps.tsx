...
const cards = [
  { num: '01', title: 'Global recruitment', body: 'Accede a +30K speekers certificados en todo el mundo. Sin fronteras, sin barreras. El talento perfecto para tu evento, esté donde esté.', img: 'https://images.unsplash.com/photo-1526948531399-320e7e40f0ca?w=600&h=400&fit=crop' },
  { num: '02', title: 'Data driven', body: 'Cada speeker tiene un score basado en datos reales: reseñas, impacto, engagement. Predice resultados antes de contratar.', img: 'https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=600&h=400&fit=crop' },
  ...
  { num: '04', title: 'Presupuesto optimizado', body: 'Compara precios en segundos. Encuentra speekers de clase mundial que se ajustan a tu presupuesto real.', img: 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=600&h=400&fit=crop' },
...
export default function ExmaValueProps() {
  ...
  return (
    <section ref={sectionRef} className="exma-value-section" data-section="value">
      <h2 ref={headRef} className="exma-value-headline exma-headline">¿Por qué Speekers?</h2>
